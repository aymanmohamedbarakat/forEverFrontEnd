            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex flex-col md:flex-row justify-between items-center pt-4">
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="btn btn-soft mt-3 md:mt-0 w-full md:w-1/2 bg-gradient-to-r from-gray-900 to-gray-700 text-white rounded-md hover:from-black hover:to-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors"
                >
                  {isSubmitting ? (
                    "Signing up..."
                  ) : (
